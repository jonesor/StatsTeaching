...
```{r comment = '>', tidy=TRUE, results='markup'}
4+3 
9-12
6/3
7*3
...
```{r comment = '>', eval = TRUE, results = 'markup', fig.cap=('A box plot'), fig.show='asis'}
...
system("pandoc -V papersize:\"a4paper\"  BB839IntroToR1.md -o pdf/BB839IntroToR1.pdf")
```
