...
```{r comment = '>', tidy=TRUE, results='markup',eval=TRUE, echo=FALSE, fig}
...
system("pandoc -V papersize:\"a4paper\"  BB817InstallingRandRStudio.md -o pdf/BB817InstallingRandRStudio.pdf")
```
